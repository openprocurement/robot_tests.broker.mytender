...
Отримати інформацію із предмету
    ...
    ${return_value}=    Run Keyword And Return    mytender.Отримати інформацію із тендера    ${username}    ${tender_uaid}    ${field_name}
    [Return]    ${return_value}
...
Отримати інформацію із тендера
    ...
    Run keyword    mytender.Перейти на сторінку тендера  ${username}  ${tender_uaid}
    ${return_value}=  Run Keyword  mytender.Отримати інформацію про ${fieldname}
    [return]  ${return_value}
...
Отримати інформацію про dgfDecisionDate
    ...
    ${return_value}=    mytender_service.convert_date    ${date_value}
    [Return]    ${return_value}
...
Отримати інформацію із запитання
    ...
    mytender.Перейти до сторінки запитань    ${username}    ${tender_uaid}
